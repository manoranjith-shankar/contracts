...
export function handleLogicContractSet(event: LogicContractSet): void {
  ...
  //
  // - contract.transferManagerFactory(...)
  // - contract.dataStoreFactory(...)
  // - contract.latestUpgrade(...)
...
export function handleDefaultTransferManagerUpdated(
  event: DefaultTransferManagerUpdated
): void {}

export function handleDefaultDataStoreUpdated(
  event: DefaultDataStoreUpdated
): void {}

export function handleOwnershipTransferred(event: OwnershipTransferred): void {}

export function handleLogicContractSet1(event: LogicContractSet1): void {}
